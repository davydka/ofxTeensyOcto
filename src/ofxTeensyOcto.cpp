...
//--------------------------------------------------------------
void ofxTeensyOcto::setup(int _ledWidth, int _ledHeight, int _rowHeight, int _stripsPerPort, int _numPorts)
{
	// LED variables
	...
	// octows2811 library takes row heights as divisions of 8, for some reason yet unknown
	// i.e. stripHeight = 96, this translates to 12 rows (96/8 = 12)
	// set this value for teensy.draw() to reflect 1 row = 1px tall, for better previewing
...
void ofxTeensyOcto::draw(int x, int y)
{
	...
	for (int y = 0; y < rowHeight*stripsPerPort*numPorts; y++)
	{
		for (int x = 0; x < ledWidth; x++)
		{
			ofPushMatrix();
